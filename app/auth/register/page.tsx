            ...
            <div className="lg:w-max w-[90%] py-10  h-max m-auto">
                ...
                <div className="bg-[#2123249f] flex flex-col gap-5  rounded-lg p-6  lg:p-8">
                    ...
                    <div className="flex flex-col gap-3">
                        <div className="p-3  px-4 rounded-lg outline-none border-none ring-offset-2 ring-offset-transparent focus:ring-1 bg-[#353536]">  <input className="outline-none bg-transparent" type="text" name="" id="" placeholder="Địa chỉ enmail đang sử dụng" /></div>
                        <div className="p-3  rounded-lg outline-none border-none ring-offset-2 ring-offset-transparent focus:ring-1 bg-[#353536]">  <input className="outline-none bg-transparent" type="text" name="" id="" placeholder="Tên tài khoản / nickname" /></div>
                        <p className='text-xs mb-4'>Tối đa 30 ký tự, chỉ chấp nhận a-z,A-Z,0-9,dấu gạch dưới</p>
                        ...
                        <div className="p-3 flex justify-between px-4  rounded-lg outline-none border-none ring-offset-2 ring-offset-transparent focus:ring-1 bg-[#353536]"><input className="outline-none bg-transparent" type={showPass ? "text" : "password"} name="" id="" placeholder="Nhập lại mật khẩu của bạn" />
                            {!showPass ? <IoEyeOffOutline size={20} onClick={() => setShowPass(true)} /> : <IoEyeOutline size={20} onClick={() => setShowPass(false)} />}
                        </div>
                    </div>
                    ...
                    <button className=" bg-[#c27324] hover:bg-[#9f662d] w-max p-3  text-sm font-bold rounded-lg">TẠO TÀI KHOẢN MỚI</button>
                    <ul className="flex flex-col gap-3 text-sm">
                        <li className="text-xs lg:w-[320px] font-bold">Khi tiến hành đăng ký và sử dụng dịch vụ của {"HoathinhOnline"}, mặc định bạn đã đồng ý với mọi điều khoản dịch vụ của chúng tôi.</li>
                        <Link href="/auth/login"><li className="hover:text-[#c27324] cursor-pointer">Đi đến trang đăng nhập</li></Link>
                    </ul>
