...
const listImg = [
    {
        urlImg: "https://hoathinh3d.io/wp-content/uploads/2021/04/the-gioi-hoan-my-poster-video.jpg",
        nameMovie: "Tên Phim",
        authorMovie: "Tên Tác Giả"

    },
    {
        urlImg: "https://www.hoathinh3d.io/wp-content/uploads/2022/10/gia-thien-poster.jpg",
        nameMovie: "Tên Phim",
        authorMovie: "Tên Tác Giả"

    },
    {
        urlImg: "https://www.hoathinh3d.io/wp-content/uploads/2022/07/tru-tien-phan-2-poster.jpg",
        nameMovie: "Tên Phim",
        authorMovie: "Tên Tác Giả"

    },
    {
        urlImg: "https://www.hoathinh3d.io/wp-content/uploads/2023/06/dau-la-dai-luc-2-poster.jpg",
        nameMovie: "Tên Phim",
        authorMovie: "Tên Tác Giả"

    },
    {
        urlImg: "https://www.hoathinh3d.io/wp-content/uploads/2023/06/thuong-nguyen-do-poster-1.jpg",
        nameMovie: "Tên Phim",
        authorMovie: "Tên Tác Giả"
        ...
        <div className='  relative  '>
            <Slider   {...settings}>
                {listImg.map((item, index) => (
                    <div key={index} className='w-full text-sm lg:h-[300px]  h-[200px] relative overflow-hidden'>
                        ...
                        <span className='absolute bottom-0 left-0 text-white w-full py-1 px-2 bg-[#212121d3]'>
                            <p className='lg:text-2xl text-xl py-1 lg:py-0'>{item.nameMovie}</p>
