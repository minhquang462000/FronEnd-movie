  ...
  return (
    <main className="w-full">
      <div className="border-b-[1px]  flex justify-between items-center pb-1 -mb-[1.55px]  border-gray-800">
        <h3 className="text-ld font-bold bg-gradient-to-r   from-orange-500 to-red-600 bg-clip-text text-transparent">
          Tủ Phim Theo Dõi
        </h3>
        <button className="text-xs text-red-400 cursor-pointer hover:text-orange-400 font-light">
      ...
      <ul className="grid grid-cols-2 py-4 md:grid-cols-4 lg:grid-cols-5 gap-2">
        <li className="w-full group/item cursor-pointer relative h-[220px] lg:h-[250px] rounded-md overflow-hidden">
          ...
          <button className="absolute -right-0 p-1 shadow-lg  cursor-pointer -top-0 hover:bg-black bg-red-700 rounded">
            <IoClose
              size={20}
              color="white"
              className="font-bold"
